...
var Todo = Class({
	...
	// Wait for the ``"render"`` event using the [onRender](http://matreshka.io/#Matreshka.Array-onRender) vierual method. The event fires when the element corresponding to the instance of the class is rendered.
	onRender: function() {
