...
class Todo extends Matreshka.Object {
    ...
    // Wait for the ``"render"`` event using the [onRender](http://matreshka.io/#!Matreshka.Array-onRender) virtual method. The event fires when the element corresponding to the instance of the class is rendered.
    onRender() {
        ...
        // * The ``"destroy"`` property is bound to the element with ``destroy`` class which does not have a default binder. It means that the element is simply associated with the property without synchronizing with its value.
            ...
            // * The visibility of the sandbox element will depend on the value of the ``"visible"`` property ([binders.display](http://matreshka.io/#!Matreshka.binders.display))
            ...
            // * Bind the element ``label`` whose ``innerHTML`` will be synchronized with the value of the ``"title"`` property ([binders.html](http://matreshka.io/#!Matreshka.binders.html))
